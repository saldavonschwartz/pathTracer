...
//using std::sort;
//
//BVHNode::BVHNode(std::vector<Hittable*>& objects, size_t start, size_t end, float t0, float t1) {
//  int axis = rand() % 3;
...
//      left = new BVHNode(objects, start, mid, t0, t1);
//      right = new BVHNode(objects, mid, end, t0, t1);
//      
//      break;
//    }
//  }
